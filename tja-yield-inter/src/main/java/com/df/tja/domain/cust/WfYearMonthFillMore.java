...
public class WfYearMonthFillMore extends WfYearMonthFill {
    ...
    /** 专业完成进度 */
    private List<WfMajorProgressRecord> majorProgressList;
    ...
    /**
     * <p> 属性majorProgressList的Getter方法. </p>
     * 
     * @return 返回majorProgressList属性的值
     */
    public List<WfMajorProgressRecord> getMajorProgressList() {
        return majorProgressList;
    }

    /**
     * <p> 属性majorProgressList的Setter方法. </p>
     * 
     * @param majorProgressList 为属性majorProgressList设置的值
     */
    public void setMajorProgressList(List<WfMajorProgressRecord> majorProgressList) {
        this.majorProgressList = majorProgressList;
    }
