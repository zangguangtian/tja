...
<div class="wrapBox ">
	<div class="col-md-12">
		<div class="tabbable-line boxless tabbable-reversed">
			<c:set var="allAuth" value="YEARFILL_HIS_LIST" />
			<sec:authorize url="/admin/ym/yearFill/toedit">
			<c:set var="allAuth" value="YEARFILL_LIST" />
...
jQuery(function(){
	...
	$("a[href='#tab_0']").on("click", function(){
		loadList("YEARFILL_LIST", $("#content"));
	});
	$("a[href='#tab_1']").on("click", function(){
		loadList("YEARFILL_HIS_LIST", $("#content"));
	});
});
